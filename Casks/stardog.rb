cask "stardog" do
  ...
  manpage "stardog-#{version}/docs/man/man1/stardog-icv-convert.1"
  manpage "stardog-#{version}/docs/man/man1/stardog-icv-explain.1"
  manpage "stardog-#{version}/docs/man/man1/stardog-icv-export.1"
  manpage "stardog-#{version}/docs/man/man1/stardog-icv-fix.1"
  manpage "stardog-#{version}/docs/man/man1/stardog-icv-report.1"
  manpage "stardog-#{version}/docs/man/man1/stardog-icv-validate.1"
  ...
  manpage "stardog-#{version}/docs/man/man8/stardog-admin-icv-add.8"
  manpage "stardog-#{version}/docs/man/man8/stardog-admin-icv-drop.8"
  manpage "stardog-#{version}/docs/man/man8/stardog-admin-icv-remove.8"
